...
const messages: Record<string, string> = {
  ...
  "invalid-display-name": "Enter a display name.",
  "display-name-too-long": "Display name must be 50 characters or fewer.",
  "profile-image-too-large": "Choose an image no larger than 5 MB.",
  "unsupported-profile-image": "Choose a PNG, JPG, or WEBP image.",
  "invalid-profile-image-dimensions": "Choose an image no larger than 4096 pixels on either side.",
  "invalid-profile-image": "KeyNest could not read that image.",
  "profile-storage-error": "KeyNest could not save the local profile.",
